/**
 * Ilustrasi bawaan varian `simple`.
 *
 * Produksi SELALU merender slot ilustrasi pada varian simple. Kalau prop
 * `illustration` tidak diberikan, slot itu diisi tanda tiga-warna 36x56 ini
 * (diukur di halaman live: slot 156x56, gambar 36x56). Komponen kita dulu
 * tidak merender apa-apa, sehingga lima buku pada halaman Book kehilangan
 * gambarnya.
 *
 * Jalur disalin VERBATIM dari DOM live 9 Agu 2026.
 */
